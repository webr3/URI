...
URI.prototype.toString = function() { return this.value.toString(); };
URI.prototype.valueOf = function() { return this.value; };
/**
 * @member URI
 * @return {URI} The URI with any fragment removed
 */
URI.prototype.defrag = function() {
	var i = this.indexOf("#");
	if (i < 0) return this;
 ...
 */
URI.prototype.heirpart = function() {
 ...
 */
URI.prototype.toAbsolute = function() {
 ...
 * @return {String}
 */
URI.prototype.removeDotSegments = function( input ) {
	var output = '';
	var q = null;
 ...
 */
URI.prototype.resolveReference = function( reference ) {
...
URI.HeirPart.prototype = new String;
URI.HeirPart.prototype.toString = function() { return this.value.toString(); };
URI.HeirPart.prototype.valueOf = function() { return this.value; };
/**
 * @member URI.HeirPart
 * @return URI.Authority The Authority of the URI or null
 */
URI.HeirPart.prototype.authority = function() {
 ...
 */
URI.HeirPart.prototype.path = function() {
...
URI.Authority.prototype = new String;
URI.Authority.prototype.toString = function() { return this.value.toString(); };
URI.Authority.prototype.valueOf = function() { return this.value; };
/**
 * @member URI.Authority
 * @return String The user-info of the URI or null
 */
URI.Authority.prototype.userinfo = function() {
	var q = this.indexOf("@");
	if(q < 0) return null;
 ...
 */
URI.Authority.prototype.host = function() {
	var host = this.value;
 ...
 */
URI.Authority.prototype.port = function() {
	var port = this.value;
...
URI.Path.prototype = new String;
URI.Path.prototype.toString = function() { return this.value.toString(); };
URI.Path.prototype.valueOf = function() { return this.value; };
